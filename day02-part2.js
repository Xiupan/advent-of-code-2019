...
const part2 = inputArray => {
  const staticClone = _.cloneDeep(inputArray);

  for (let a = 0; a < 100; a++) {
    for (let b = 0; b < 100; b++) {
      inputArray[1] = a;
      inputArray[2] = b;
      if (part1(inputArray) !== 19690720) {
        // console.log(`Answer is ${part1(inputArray)}, with ${a} and ${b}.`);
        inputArray = _.cloneDeep(staticClone);
      } else {
        console.log(`Answer is Noun: ${a} and Verb: ${b}`);
        break;
      }
    }
  }
